...
//    val handler = new SocketConnectionHandler[Nothing, Int] {
...
//      override def worker: Process[Int]                             = TestMainSimple
...
//    val handler      = new ProcessCommunicationHandler[Int](serverSocket, _ => ())
//
//    val proc = new Runner[Int] {
//      override def socket: ServerSocket                            = serverSocket
//      override def config: ScalamuConfig                           = cfg
//      override def worker: Process[Int]                             = TestMainSending
//      override def connectionHandler: SocketConnectionHandler[Int] = handler
//      override def compiledSourcesDir: Path                        = Paths.get(".")
//      override def sendConfigurationToWorker(dos: DataOutputStream): Unit   = ???
//    }
...
//}
//
//object TestMainSimple extends Process[Int] {
...
//}
//
//object TestMainSending extends Process[Int] {
